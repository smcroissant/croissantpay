      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-5 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li><a href={`${base}/login`} className="hover:text-foreground transition-colors">Sign In</a></li>
              <li><a href={`${base}/register`} className="hover:text-foreground transition-colors">Get Started</a></li>
            </ul>
          </div>
          <div>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 pt-8 border-t border-border">
          ...
          <div className="flex items-center gap-4">
            <a href="https://github.com/croissantpay/croissantpay" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-foreground transition-colors">
              <Github className="w-5 h-5" />
            </a>
            <a href="https://twitter.com/croissantpay" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-foreground transition-colors">
