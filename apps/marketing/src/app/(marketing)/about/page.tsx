    ...
    <div className="min-h-screen bg-background">
      <nav className="sticky top-0 z-50 border-b border-border bg-card/95 backdrop-blur">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <Link href="/docs" className="px-4 py-2 rounded-lg text-muted-foreground hover:text-foreground transition-colors">
              Docs
            </Link>
            <a href={`${base}/dashboard`} className="px-4 py-2 rounded-lg bg-primary text-primary-foreground hover:bg-primary/90 transition-colors">
              Dashboard
            </a>
          </div>
        </div>
      ...
      <section className="py-20 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <BeliefCard title="Transparency" description="No hidden fees, no surprise charges. You know exactly what you're paying for." />
            <BeliefCard title="Simplicity" description="Complex problems deserve elegant solutions. We obsess over developer experience." />
            <BeliefCard title="Community" description="We build in the open and welcome contributions. Your feedback shapes the product." />
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-6 border-t border-border">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-muted-foreground mb-8">Join thousands of developers building with CroissantPay</p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href={`${base}/register`} className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-xl bg-primary text-primary-foreground font-semibold hover:bg-primary/90 transition-colors">
              Get Started Free
            </a>
            <Link href="/contact" className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-xl bg-secondary font-semibold hover:bg-secondary/80 transition-colors">
              Contact Us
            </Link>
          </div>
        </div>
