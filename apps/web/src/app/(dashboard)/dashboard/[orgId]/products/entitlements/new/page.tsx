...
export default function NewEntitlementPage() {
  ...
  const createEntitlement = trpc.products.createEntitlement.useMutation({
    onSuccess: () => {
  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <div className="mb-8">
        <h1 className="text-2xl font-bold mb-2">Create Entitlement</h1>
        <p className="text-muted-foreground">Define access rights for your users</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="flex gap-3">
          ...
          <button
            type="submit"
            disabled={createEntitlement.isPending || !formData.appId || !formData.identifier || !formData.displayName}
          ...
          >
            {createEntitlement.isPending ? <Loader2 className="w-5 h-5 animate-spin mx-auto" /> : "Create Entitlement"}
          </button>
        </div>
      </form>
    </div>
